    ...
    def get_ticket(self):
        for host in self.hosts:
            try:
                ...
                oauth_login_only = acc.get("oauth_login_only", False)

                if ticket:
                    return ticket, oauth_login_only
...
if __name__ == "__main__":
    ...
    ticket, oauth_login_only = flow.get_ticket()
    ...
    print("\n🎫 Ticket:", ticket)
    print("🔐 oauth_login_only:", oauth_login_only)

    # =========================
    # FLOW LOGIC
    # =========================
    if oauth_login_only is False:
        print("\n➡️ DIRECT LOGIN FLOW")
